        ...
        <div class="modal-content border-0">
            <div class="modal-header bg-dark text-white">
                <h5 id="productModalLabel" class="modal-title">
                    ...
                    <span v-else="isActionAdd">編輯產品</span>
                </h5>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="mb-2">
                            <div class="mb-3">
                                ...
                                <input v-model="selectedProduct.imageUrl" type="text" class="form-control"
                                    placeholder="請輸入圖片連結">
                            </div>
                        ...
                        <div class="mb-2" v-for="(image, index) in selectedProduct.imagesUrl" :key="image">
                            <div class="mb-3">
                                ...
                                <div style="display: flex">
                                    <input v-model="selectedProduct.imagesUrl[index]" type="text"
                    ...
                    <div class="col-sm-8">
                        <div class="mb-3">
                            ...
                            <input v-model="selectedProduct.title" id="title" type="text" class="form-control"
                                placeholder="請輸入標題">
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input v-model="selectedProduct.category" id="category" type="text"
                                    class="form-control" placeholder="請輸入分類">
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="price" class="form-label">單位</label>
                                <input v-model="selectedProduct.unit" id="unit" type="text" class="form-control"
                                    placeholder="請輸入單位">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input v-model.number="selectedProduct.origin_price" id="origin_price"
                                    type="number" min="0" class="form-control" placeholder="請輸入原價">
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="price" class="form-label">售價</label>
                                <!-- 使用 .number 以符合 api 要的資料類型-->
                                <input v-model.number="selectedProduct.price" id="price" type="number" min="0"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea v-model="selectedProduct.description" id="description" type="text"
                                class="form-control" placeholder="請輸入產品描述">
            </textarea>
                        </div>
                        <div class="mb-3">
                            <label for="content" class="form-label">說明內容</label>
                            <textarea v-model="selectedProduct.content" id="description" type="text"
                                class="form-control" placeholder="請輸入說明內容">
            </textarea>
                        </div>
                        <div class="mb-3">
                            <div class="form-check">
                                <input v-model="selectedProduct.is_enabled" id="is_enabled"
            ...
            <div class="modal-footer">
                ...
                <button v-else="isActionAdd" type="button" class="btn btn-primary" @click="editProduct">
                    確認
                </button>
            </div>
        </div>
